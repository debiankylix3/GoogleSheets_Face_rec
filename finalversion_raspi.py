...
def recognize_and_order_from_db():
    """
    Recognize users via Picam2 and process their orders using the SQLite database.
    - Captures images using Picam2.
        ...
        while True:
            ...
            for face_encoding in face_encodings:
                ...
                if matches[best_match_index]:
                    ...
                    picam2.stop()  # Stop the camera after recognition
                    return  # Exit after recognizing one user
                else:
                    # Face not recognized
                    print("Face not recognized. Please register first.")
    finally:
        # Ensure the Picam2 is properly released in case of any exception
        picam2.stop()
